...
<section class="ia-page ia-page--archive" lang="zh-Hant">
  ...
  <section class="ia-grid ia-grid--two" aria-label="過往工作分類">
    ...
    <article class="ia-panel"><p class="ia-tech-label">COMPETITIONS</p><h2>競賽與團隊工程</h2><p>保留已公開的 CTF 與過往競賽紀錄，但不作為首頁主要內容。</p><p class="ia-related"><a href="/experience/competitions/">查看已公開競賽紀錄</a></p></article>
